package org.makeMyTrip.qa.base;
...
import org.makeMyTrip.qa.util.WebEventListener;
...
public class TestBase {
	...
	public TestBase() {
		try {
		prop=new Properties();
		FileInputStream ip=new FileInputStream("C:\\Users\\Snehalesh\\eclipse-workspace\\org.com.test1\\src\\main\\java\\org\\makeMyTrip\\qa\\config\\config.properties");
		prop.load(ip);
